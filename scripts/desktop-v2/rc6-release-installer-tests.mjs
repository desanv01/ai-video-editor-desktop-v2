...
const [pkg, lock, tauri, cargo, cargoLock, hook, trust, build, migration, credentials, uninstallSchema, releaseSchema, ffmpeg, nativePackager, ffmpegProvenance, catalog, assembler, provenance, verifier, docs] = await Promise.all([
...
console.log("Desktop V2 RC6 release/installer tests passed: coherent developer trust, per-machine NSIS/WiX identity, bounded uninstall/full wipe, pinned FFmpeg provenance, and non-overwriting release assembly are frozen.");
