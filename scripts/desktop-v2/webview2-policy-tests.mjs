...
assert.match(detector, /Get-FilesystemRuntime/);
assert.match(detector, /Get-VerifiedExecutableVersion/);
assert.match(detector, /EdgeWebView/);
assert.match(detector, /ProductVersion/);
assert.match(detector, /evergreen-filesystem/);
assert.match(detector, /exit \$exitCode/);
...
assert.match(rust, /detect_webview2_filesystem/);
assert.match(rust, /windows_pe_product_version/);
assert.match(rust, /MAX_WEBVIEW2_VERSION_DIRECTORIES/);
assert.match(rust, /GetFileVersionInfoW/);
assert.match(rust, /evergreen-filesystem/);
